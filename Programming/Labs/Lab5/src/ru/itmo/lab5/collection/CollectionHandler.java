...
public class CollectionHandler 
{
	 ...
	 * @see ru.itmo.lab5.util.Constants#ENV_VAR_NAME
	 */
	...
	public void printCollection()
	{
		...
		Stream.of(ElementCommand.getAllFields()).forEach(field -> Printer.OUT.printf("/ %s.%s ", field.getDeclaringClass().getSimpleName(), field.getName()));
